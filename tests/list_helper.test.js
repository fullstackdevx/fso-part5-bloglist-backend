...
describe('Favorite blog', () => {
  ...
  const listOfBlogsWithOneFavorite = [
    {
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
      author: 'Michael Chan',
  ...
  const listOfBlogsWithMoreThanOneFavorite = [
    {
      _id: '5a422a851b54a676234d17f7',
      title: 'React patterns',
      author: 'Michael Chan',
  ...
  test('of a bigger list with only one favorite is calculated right', () => {
    const expectedBlog = {
      title: 'React patterns',
      author: 'Michael Chan',
      likes: 7
    }
    expect(listHelper.favoriteBlog(listOfBlogsWithOneFavorite)).toEqual(expectedBlog)
  })

  test('of a bigger list with many top favorite, returns the first one', () => {
    const expectedBlog = {
      title: 'Go To Statement Considered Harmful',
      author: 'Edsger W. Dijkstra',
      likes: 12
    }
    expect(listHelper.favoriteBlog(listOfBlogsWithMoreThanOneFavorite)).toEqual(expectedBlog)
  })
})
...
describe('Most blogs', () => {
  ...
  test('returns the author who has the largest amount of blogs, and the number of blogs', () => {
